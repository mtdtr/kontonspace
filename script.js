...
function genkanshow(){
  document.getElementById('membervoid').innerHTML = '<h3>玄関</h3><p class="small"><i>a.k.a.魚好きよ</i></p><p>ラ<br>ララ<br>ら・ララランド<br>魚が好き(本人談)</p><p>当サークル専属メイドさん。</p><p><span style="background-color:#777777;color:#ffffff;">担当楽器:サイリウム</span></p>';
}

function domashow(){
  document.getElementById('membervoid').innerHTML = '<h3>土間</h3><p class="small"><i>a.k.a.シャロリング</i></p><p>当サークル専属絵師にして3人目のメンバー(ピアノ含む)。アイコンは本人が描いてくれました!</p><p><span class="small" style="color:#999999;">某</span>和太鼓<span class="small" style="color:#999999;">風ゲーム</span>8段取得。</p><p><span style="background-color:#777777;color:#ffffff;">担当楽器:和太鼓・サイリウム・ピアノ(予定)</span></p>';
}

function kutsubakoshow(){
  document.getElementById('membervoid').innerHTML = '<h3>玄関</h3><p class="small"><i>a.k.a.ふぃぎゅ</i></p><p>保健の成績は5だけど体育の成績は1。(本人談)</p><p>そろばん(マラカス)初段取得。</p><p>アイコンは土間さんが描いてくれました。</p><p><span style="background-color:#777777;color:#ffffff;">担当楽器:そろばんマラカス・サイリウム</span></p>';
}
